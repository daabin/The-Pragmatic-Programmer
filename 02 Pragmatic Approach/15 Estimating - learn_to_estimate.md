...
Program Evaluation Review Technique, or
PERT.

<a id="d24e6613"></a>
Every PERT task has an optimistic, a most likely, and a pessimistic
estimate. The tasks are arranged into a dependency network, and then
...
- Start keeping a log of your estimates. For each, track how
  accurate you turned out to be. If your error was greater than 50%,
  try to find out where your estimate went wrong.

### Exercises

<a id="exercise-9"></a>
**Exercise 9** ([possible answer](<../A2 Exercise Answers/README.md#answer-9>))
...
<a id="exercise-10"></a>
**Exercise 10** ([possible answer](<../A2 Exercise Answers/README.md#answer-10>))
