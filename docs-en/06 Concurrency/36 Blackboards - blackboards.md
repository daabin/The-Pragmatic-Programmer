...
<a id="d24e18872"></a>
Consider how detectives might use a blackboard to coordinate
...
A sample blackboard is shown in [the figure](#fg-blackboard).
...
Figure 2. Someone found a connection between Humpty's gambling debts and the
phone logs. Perhaps he was getting threatening phone
calls.

A figure shows a blackboard with the clues to the topic Humpty Dumpty (male, egg). Based on the following details, the case can be closed either accident or murder. The details are, photos, king's men, eye witness (gathered by Detective Holmes); Shell fragments, gambling debts, and Graffiti on wall (gathered by Detective marple); Phone logs and information about wife alibi (gathered by Detective Spade).
...
must ask for certain information—but must not ask
...
<a id="d24e19009"></a>
<a id="d24e19012"></a>
- Responses can arrive in any order. For
  instance, queries for a credit check or title search may take a
  substantial amount of time, while items such as name and address may
...
- Nonetheless, certain data may still be dependent on other data. For
  instance, you may not be able to start the title search for a car
...
- Topic 29, [*Juggling the Real World*](<../05 Bend or Break/29 Juggling the Real World - event.md#event>)
- Topic 33, [*Breaking Temporal Coupling*](<33 Breaking Temporal Coupling - temporal_coupling.md#temporal_coupling>)
- Topic 35, [*Actors and Processes*](<35 Actors and Processes - actor_model.md#actor_model>)

### Exercises

<a id="exercise-24"></a>
**Exercise 24** ([possible answer](<../A2 Exercise Answers/README.md#answer-24>))
