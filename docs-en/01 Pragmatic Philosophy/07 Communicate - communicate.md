...
ideas on style and layout. Check the spelling, first automatically and
...
want people to listen to you: listen to them. Even if this is a
...
<a id="d24e2336"></a>
However, this doesn't mean we agree with the folks who say that every function, data structure, type declaration, etc., needs its own comment. This kind of mechanical comment writing actually makes it more difficult to maintain code: now there are two things to update when you make a change. So restrict your non-API commenting to discussing why something is done, its purpose and its goal. The code already shows how it is done, so commenting on this is redundant—and is a violation of the DRY
principle.
...
- Topic 18, [*Power Editing*](<../03 Basic Tools/18 Power Editing - get_good_at_editing.md#get_good_at_editing>)
...
- There are several good books that contain sections on
  communications within teams, including [*The Mythical Man-Month: Essays on Software Engineering* [Bro96]](<../A2 Exercise Answers/README.md#d6040e160>) and
  [*Peopleware: Productive Projects and Teams* [DL13]](<../A2 Exercise Answers/README.md#d6040e306>).
  Make it a point to try to read
  these over the next 18 months. In addition, [*Dinosaur Brains: Dealing with All Those Impossible People at Work* [BR89]](<../A2 Exercise Answers/README.md#d6040e120>) discusses the emotional baggage we
...
[[12]](#FNPTR-12)The word annoy comes from the Old French enui, which also means “to bore.''
