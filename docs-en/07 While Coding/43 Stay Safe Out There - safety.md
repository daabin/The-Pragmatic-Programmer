...
dissidents.” We were wrong. In fact, you do need to be that paranoid,
every day.
...
will seize on any opening we leave to compromise our systems. Your particular
...
<a id="d24e23566"></a>
In Topic 19, [*Version Control*](<../03 Basic Tools/19 Version Control - version_control.md#version_control>) we strongly recommend putting everything needed for the project under version control. Well, almost everything. Here's one major exception to that rule:
...
- Topic 38, [*Programming by Coincidence*](<38 Programming by Coincidence - coincidence.md#coincidence>)
