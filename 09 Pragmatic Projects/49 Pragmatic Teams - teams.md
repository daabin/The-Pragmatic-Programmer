...
<a id="d24e25842"></a>
<a id="FNPTR-75"></a>
A team, in our view, is a small, mostly stable entity of its own. Fifty people aren't a team, they're a horde.[[75]](<../10 Postface/README.md#FOOTNOTE-75>) Teams where members are constantly being pulled onto other assignments and no one knows each other aren't a team either, they are merely strangers temporarily sharing a bus stop in the rain.
...
imperfections that no one fixes. The team must take
responsibility for the quality of the product, supporting developers
who understand the no broken windows philosophy we describe in
Topic 3, [*Software Entropy*](<../01 Pragmatic Philosophy/03 Software Entropy - no_broken_windows.md#no_broken_windows>), and encouraging those who haven't yet
discovered it.
...
the individual contributions of all team members. Quality is built in,
not bolted on.
...
Topic 4, [*Stone Soup and Boiled Frogs*](<../01 Pragmatic Philosophy/04 Stone Soup and Boiled Frogs - stone_soup.md#stone_soup>)? It doesn't notice the gradual change in its
...
original understanding. Keep metrics on new requirements.[[76]](<../10 Postface/README.md#FOOTNOTE-76>)
...
<a id="d24e26005"></a>
In Topic 6, [*Your Knowledge Portfolio*](<../01 Pragmatic Philosophy/06 Your Knowledge Portfolio - knowledge.md#knowledge>) we looked at ways you should invest in your personal Knowledge Portfolio on your own time. Teams that want to succeed need to consider their knowledge and skill investments as well.
...
:   Continuous improvement can only happen when you take the time to look around, figure out what's working and not, and then make changes (see Topic 48, [*The Essence of Agility*](<../08 Before the Project/48 The Essence of Agility - essence_of_agility.md#essence_of_agility>)). Too many teams are so busy bailing out water that they don't have time to fix the leak. Schedule it. Fix it.
...
speaks with one voice.[[77]](<../10 Postface/README.md#FOOTNOTE-77>) They may even have a sense of humor.
...
<a id="d24e26163"></a>
In Topic 9, [*DRY—The Evils of Duplication*](<../02 Pragmatic Approach/09 DRY - The Evils of Duplication - dry.md#dry>), we talked about the difficulties of eliminating
...
<a id="d24e26215"></a>
<a id="FNPTR-78"></a>
If you have to wait a week for the team meeting to ask your question or share your status, that's an awful lot of friction.[[78]](<../10 Postface/README.md#FOOTNOTE-78>) Frictionless means it's easy and low-ceremony to ask questions, share your progress, your problems, your insights and learnings, and to stay aware of what your teammates are doing.
...
Make sure the team has skills at tool building
...
Topic 5, [*Good-Enough Software*](<../01 Pragmatic Philosophy/05 Good-Enough Software - good_enough_sw.md#good_enough_sw>), resist the temptation to
add more paint.
...
- Next time you start a project, try convincing people to
  brand it. Give your organization time to become used to the
  idea, and then do a quick audit to see what difference it made, both
  within the team and externally.
- You were probably once given problems such as “If it
  takes 4 workers 6 hours to dig a ditch, how long would it take 8
  workers?” In real life, however, what factors affect the
  answer if the workers were writing code instead? In how
  many scenarios is the time actually reduced?
- Read [*The Mythical Man Month* [Bro96]](<../A2 Exercise Answers/README.md#d6040e160>) by Frederick Brooks. For extra credit, buy two copies so you can read it twice as fast.
